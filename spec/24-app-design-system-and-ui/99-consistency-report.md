...
**Version:** 2.2.9
**Updated:** 2026-05-11 (Sess-82 B-2-§24 — minted §97 closed-set "Mechanically enforced by — gate-citation matrix"; mirror of §23 §97 Sess-81 B-2-§23 closure)

> **v2.2.9 update (Sess-82 B-2-§24 — closed-set gate-citation matrix in §97):** Inserted "Mechanically enforced by — gate-citation matrix" between Inlined Contracts and Acceptance Criteria in `97-acceptance-criteria.md` (v3.8.0 → **v3.9.0**). Maps all 17 AC-ADS-NN families (AC-ADS-01..17) to their auditing §27 gate slot. Slot-reuse distribution: `36-check-ads-boundaries.md` ×6 (35% — primary §24 boundary auditor, reflecting strict-additive-overlay relationship to §07), `53` ×2 (AppShell), `49` ×2 (Sidebar), `01` ×2, `03` ×2, `02` ×2, all others ×1. Coverage **17/17 (100%)**. Sister to §27 `00-cross-cohort-read-order-dag.md` edge **E-5** (§27 → §24 audit-surface coverage). Mirror of §23 §97 Sess-81 matrix shape and 4-clause reflexive drift contract: (1) same-PR row addition for new ACs (enforced by `47-check-ac-section-orphan-header.md`); (2) §27 slot renumber refresh (enforced by `64-meta-verify-lockstep.md`); (3) status-column floor at `active` with §99 downgrade banner if regressed; (4) cross-cohort consistency citing §27 only (enforced by edge **E-5**). Banners: §97 v3.8.0 → **v3.9.0**; §00 v4.13.0 → **v4.14.0**; §98 v4.16.0 → **v4.17.0**; this file v2.2.8 → **v2.2.9**. **Scorecard impact (Sess-82 B-2-§24):** §24 R-band C4 (Consistency) carried at 20 (already at ceiling per Sess-69 baseline) — defensibility hardened by citation-closure mechanism now sister to §23 closure. C1/C2/C3/C4/C5/C6 carried at 20/20/19/20/20/20 (sole below-ceiling criterion remains C3 Testability — addressed by deferred B-29 lever). §24 Raw-LLM /120 **carried at 119**. **Lovable + Cursor unchanged at 120**. Aggregate Raw-LLM Σ **carried at 823/840** (this turn is a score-holding defensibility refresh; no point-lift). §27 remains sole Raw-LLM cohort floor at R 112. Closes B-2-§24 from Sess-81 remaining-tasks list. Prior: Sess-75 B-27-§24 walker-cost reflexivity lever.
