...
**Version:** 2.90.3
**Updated:** 2026-05-10 (Phase-5 T-15 — slot 39 `check-applink-xor-clause.py` shipped as gate #22 closing §27 backlog `applink-xor-check-clause-present`; promotes §23 AC-ADB-05 + AC-ADB-13 + AC-ADB-R-4 inv-6 to load-proven; §23 R-tier C5 = 20 now un-conditional)
