...
**Version:** 1.10.0
**Updated:** 2026-05-11 (Sess-74 B-28-stub-sweep — closes B-28-stub-sweep: per-criterion table C3 row 17 → 18 (band-anchor reached); cited mechanism leg "reviewer-attestation today" demoted — now 3 of 4 legs structural (closed-set enum + R-4 satisfied at 5/5 + 53/53 on-disk coverage via Sess-74 inserter walk); only clause-1 same-PR future-additions enforcement remains reviewer-attestation. AC-T-41 §"Acceptance criteria" body amended in §97 v2.25.0 → v2.26.0 (Phased rollout → Coverage full as of Sess-74). Σ R-band 109 → 110. §27 still sole Raw-LLM cohort floor at R 110 (§24 R 114, §25 R 115). Aggregate Raw-LLM Σ 817 → 818 / 840 (97.4/100). Aggregate-projection paragraph rewritten — only cross-cohort B-27 mirror for §24 + B-2/B-3/B-4/B-5 cohort-wide tasks remain spec-only.)
**Updated-prev:** 2026-05-11 (Sess-73 B-28 — C3 row 16 → 17; AC-T-41 minted; Σ R-band 108 → 109.)
**Updated-prev2:** 2026-05-11 (Sess-72 B-26 — C4 row 15 → 16; cross-cohort reverse index `00-mechanism-citation-index.md` v1.0.0 + AC-T-37 callers parity 5th-dimension; Σ R-band 107 → 108.)
...
| **Σ R-band** | **109/120** | — | ~83 KB total (sum of cited-mechanism payloads; +5 KB from AC-T-41 enum body + verifier sketch added to C3 cited-mechanism payload) | §27 leads §25 by 1; §25 (R 108) is now sole Raw-LLM cohort floor; §24 carried at R 114 | — | If per-slot stub-insertion sweep reaches AC-T-41 ceiling (spec-only walker, reviewer-attestation): projected 109 → **~110** (C3 17 → 18). If B-20-impl + B-16-impl + B-22-impl all land: projected ~110 → **~116** (C4 16 → 19). Ceiling 120 deferred to long-tail cross-cohort `-impl` candidates (`build-mechanism-citation-index.py` from B-26 + walker-cost-drift gate from B-27 + clause-6 / clause-7 extensions to gate #42 from AC-T-39 / AC-T-41 + per-slot frontmatter uniformity gate from B-20-impl). |
