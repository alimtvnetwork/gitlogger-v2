...
**Version:** 4.46.0  
**Updated:** 2026-05-10 (Phase-5 G-6c-followup — gate #33 disk run flipped warn-only → HARD-FAIL; all 14 clause-5 unlabelled-fence violations resolved by per-fence `**PRIMARY lane (SQLite — MATERIALISE):**` markers in §23 §00 (13 fences) + §23 §97 (1 fence) + REFERENCE-lane re-banner of the §23 §00 PostgreSQL appendix RLS-policies fence; `python3 linter-scripts/check-dialect-precedence-banner-present.py` → `OK (mode=all)`; `meta-verify-lockstep.py` still 0 violations; gates #24/#34/#35 still 0 violations; phantom ledger unchanged at 22 (no new gate this turn). Scorecard: §23 R-band Cursor 120 carried; §23 R-band Raw-LLM **119 → 120** (C3 Testability +1 — clause-5 disk-side reconciliation lifts the last gate-#33 conditional surface to load-proven; §23 joins §27/§28 at triple-ceiling 120/120/120 in the Raw-LLM persona). §22 unchanged at v4.47.0 lift. §27 R-band unchanged.
