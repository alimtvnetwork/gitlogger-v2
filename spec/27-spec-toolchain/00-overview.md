...
**Version:** 3.5.0  
**Updated:** 2026-05-10 (Session 42 audit-task A-22 — D1 `error-envelope-shape-check` promoted Deferred → Active as gate #17. Eighth deferred→Active conversion (8/9). Active gate count 16 → 17; deferred backlog 2 → 1. First integration-test conversion: HTTP round-trip harness driving §23 writer-paths against §22 `17-openapi.yaml` `ErrorEnvelope` schema. Declaring AC §22 AC-COHORT-01 (J-1) qualifier removed in same PR — machine-enforced by gate #15. Only D3 remains; A-23 closes the entire 9/9 backlog. Prior: Sess-41 A-21 D4 promotion.)
